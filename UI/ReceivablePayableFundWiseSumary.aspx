<%@ Page Language="C#"  MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="ReceivablePayableFundWiseSumary.aspx.cs" Inherits="UI_BalancechekReport" Title="Sell Buy Fundwise Reconcilation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="text-align: center">
        <tr>
            <td class="FormTitle" align="center">Sell Buy Fundwise Reconcilation Summary</td>
            <td>
                <br />
            </td>
        </tr>
