<%@ Page Language="C#" MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="FundTransactionReportWithPortfilio.aspx.cs" Inherits="UI_FundTransactionReport" Title="Untitled Page" %>
...
<table width="750" style="text-align:center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td align="right" style="font-weight: 700">Compare<b> Date :</b></td>
        <td align="left">
