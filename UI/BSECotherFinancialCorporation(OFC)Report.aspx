<%@ Page Language="C#" MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="BSECotherFinancialCorporation(OFC)Report.aspx.cs" Inherits="UI_PortfolioWithNonListedSecurities" Title="Individual Portfolio Statement Report Page" %>
...
<table align ="center">
    <tr>
        <td class="FormTitle" align="center">
            BSEC Other Financial Corporations(OFC) Report
        </td>           
        <td>
            &nbsp;</td>
    </tr> 
