<%@ Page Language="C#"  MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="Payment to istcl.aspx.cs" Inherits="UI_BalancechekReport" Title="Receivable Payable DSE and CSE Separate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="text-align: center">
        <tr>
            <td class="FormTitle" align="center">Payment to ISTCL</td>
            <td>
                <br />
            </td>
        </tr>
      ...
      <table style="text-align: center">
        ...
        <td align="right"> 
            <asp:Label ID="BANkNameDropDownListlabel"  style="font-weight: 700" runat="server" Text="Bank Name:"></asp:Label>
        </td>
            <td align="left" width="200px">
            <asp:DropDownList ID="DropDownListbank"  runat="server" TabIndex="6"
                AutoPostBack="True">
            </asp:DropDownList>
        </td>
    </tr>
