...
public partial class UI_DividendReceived : System.Web.UI.Page
{
    ...
    protected void postedButton_Click(object sender, EventArgs e)
    {
        ...
        foreach (DataGridItem gridRow in leftDataGrid.Items)
        {
            ...
            if (leftCheckBox.Checked)
            {
                ...
                string comp_cd = gridRow.Cells[5].Text.ToString();
                ...
                string strBOndComp = "select *  from COMP where COMP_CD=" + comp_cd;
                ...
                if (dtBOndComp.Rows.Count > 0)
                {
                    ...
                    {
                        accReceivedVCHNo = SaveDividendAccountVoucherForBond(fund_code, totalShare, net_amt, Tax_amt, comp_name, diviRatePerShare, fy, DIV_RRCIVED_ACC_VCH_NO, PaymentDt, LoginName);
                    }
                    else
                    {
        ...
        try
        {
           ...
           // string accountSchema = "UNIT_BR";
            ...
            if (taxAmount > 0)
            {
                ...
                htInsert.Add("TRAN_TIME", DateTime.Now.ToShortTimeString());
                htInsert.Add("TRAN_DATE", payDate);
                htInsert.Add("REMARKS", " Div. Tax Diducted (of vch_no=" + divReceivable_acc_vch_no + ") from " + comp_name + " for fy:" + fy + " of Share:" + totalShare + " @" + diviRate);
                htInsert.Add("TRAN_TYPE", "D");
                htInsert.Add("VOUCHER_NO", VoucherNo);
    ...
    public string SaveDividendAccountVoucherForBond(int fund_code, long totalShare, double totalDivAmt, double taxAmount, string comp_name, decimal diviRate, string fy, string divReceivable_acc_vch_no, string payDate, string LoginName)
    {
    ...
    public void clear()
    {
        ...
        //PaymenttypeDropDownList.SelectedValue = "0";
        //TaxRateTextBox.Text = "";
    }
